      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
          ...
          <div className="flex gap-4 flex-col">
            ...
            <div className="flex gap-4 flex-col items-center pt-8 pb-2">
            ...
            <p className="text-lg  md:text-2xl leading-relaxed tracking-tight text-muted-foreground max-w-6xl text-center pt-12">
